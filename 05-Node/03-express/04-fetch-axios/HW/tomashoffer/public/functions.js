...
arr.forEach(studient=>{html += `<li href="#" class="list-group-item list-group-item-action list-group-item-primary">Name: ${studient.name} - Age: ${studient.age} - Average Grade: ${studient.average} - Id: ${studient.id}</li>`})
}else{
