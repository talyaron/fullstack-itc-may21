...
function register(ev) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, email, username, password, passwordVerify, imageUrl, favColor, passRegExRule, passRegEx, registerUser, _b, title, text, error_1;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 2, , 3]);
                    ev.preventDefault();
                    _a = ev.target.elements, email = _a.email, username = _a.username, password = _a.password, passwordVerify = _a.passwordVerify, imageUrl = _a.imageUrl, favColor = _a.favColor;
                    email = email.value;
                ...
                case 1:
                    ...
                    _b = registerUser.data, title = _b.title, text = _b.text;
                    swal({
                        title: title,
                        text: text,
                        icon: "success",
