...
function handleSubmit(ev) {
    return __awaiter(this, void 0, void 0, function () {
        var name, imageURL, color, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ev.preventDefault();
                    name = ev.target.children.name.value;
                    imageURL = ev.target.children.imageURL.value;
                    color = ev.target.children.color.value;
...
function renderAllUsers() {
    return __awaiter(this, void 0, void 0, function () {
        var html, userHolder, allUsers;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    html = '';
                    userHolder = document.querySelector(".holder");
                    return [4 /*yield*/, axios.get("/user/getAllUsers")];
                case 1:
                    allUsers = _a.sent();
                    allUsers.data.users.map(function (users) {
