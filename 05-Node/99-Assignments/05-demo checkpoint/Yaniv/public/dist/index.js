...
function welcome() {
    return __awaiter(this, void 0, void 0, function () {
        var userWelcome, _a, isAdmin, storeUuid, h1Text, message, h1, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    userWelcome = _b.sent();
                    _a = userWelcome.data, isAdmin = _a.isAdmin, storeUuid = _a.storeUuid, h1Text = _a.h1Text, message = _a.message;
...
function login(ev) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, email, password, loginUser, _b, title, text, error_2;
            ...
            switch (_c.label) {
                ...
                case 1:
                    ...
                    swal({
                        ...
                        .then(function () { window.location.href = './all-users.html'; });
                    return [3 /*break*/, 3];
                case 2:
                    error_2 = _c.sent();
