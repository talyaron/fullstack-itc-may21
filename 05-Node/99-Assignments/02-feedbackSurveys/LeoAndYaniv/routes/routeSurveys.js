...
router.route('/survey/:uuid')
    .post(UserCookie_1.userCookieRead, /* isAdmin, */ controlerSurvey_1.newSurvey)
    .get(UserCookie_1.userCookieRead, /* isAdmin, */ controlerSurvey_1.getSurveys)["delete"](UserCookie_1.userCookieRead, /* isAdmin, */ controlerSurvey_1.deleteSurvey);
router.route('/question/:uuid/:qUuid')
    .post(UserCookie_1.userCookieRead, /* isAdmin, */ controlerSurvey_1.addQuestion)
    .put(UserCookie_1.userCookieRead, /* isAdmin, */ controlerSurvey_1.editQuestion)["delete"](UserCookie_1.userCookieRead, /* isAdmin, */ controlerSurvey_1.deleteQuestion);
