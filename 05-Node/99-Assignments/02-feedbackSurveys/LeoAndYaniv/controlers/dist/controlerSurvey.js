...
function newSurvey(req, res) {
    ...
    var allSurveys = new surveys_1.Surveys; //YS: Same as with users class, would be better to have just one instance of this class
...
function addQuestion(req, res) {
    var uuid = req.params.uuid;
    var allSurveys = new surveys_1.Surveys;
    var surveyToUpdate = new surveys_1.Survey(allSurveys.surveys[allSurveys.findSurveyIndex(uuid)]); //YS: Same as before
