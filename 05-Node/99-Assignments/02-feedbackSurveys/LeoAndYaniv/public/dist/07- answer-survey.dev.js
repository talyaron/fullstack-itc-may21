...
var uuid = url.searchParams.get("uuid"); //YS: Good
...
function answerSubmit(ev) {
  var answeredQuestions, index, element, answeredQuestion, submitAnswers;
    ...
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          ...
          _context3.next = 5;
          return regeneratorRuntime.awrap(axios.post("/user/answerLoginAfter/".concat(uuid)));

        case 5:
          submitAnswers = _context3.sent;
        ...
        case 9:
          ...
          location.href = "http://localhost:3000/06-%20answer-login.html?".concat(uuid);
