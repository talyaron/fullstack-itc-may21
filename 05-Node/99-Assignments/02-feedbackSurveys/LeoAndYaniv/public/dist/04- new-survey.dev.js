    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 10:
          ...
          renderQuestions();
          AddQuestionBtn = document.querySelector('#buttonCreate'); //YS: Shouldnt be capitalized
          ...
          SubmitSurvey = document.querySelector('#buttonUpload'); //YS: Shouldnt be capitalized
