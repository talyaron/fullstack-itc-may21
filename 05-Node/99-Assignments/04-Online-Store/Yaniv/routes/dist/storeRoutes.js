...
router
    ...
    .post('/addProduct/', isLoggedInAndAuthenticated, doesUserExist, isAdmin, onlyAdmin, validateBody(productSchema), addProduct)["delete"]('/product/:productUuid', isLoggedInAndAuthenticated, doesUserExist, isAdmin, onlyAdmin, deleteProduct);
