...
router.post('/logIn', validateUser_1.validateUser(schemaUser_1.schemaLogIn), encriptPsw_1.compareLogin, sendCookie_1.sendCookieUser, userControllers_1.logInUser); //YS: Why do you have a POST and GET login? You just need the post. 
