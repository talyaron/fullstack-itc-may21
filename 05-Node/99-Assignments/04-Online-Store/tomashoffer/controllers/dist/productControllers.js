...
var cookieParser = require("cookie-parser"); //YS: This is not being used
var methodProd = new product_1.ProductMethods();
var allProds = product_1.readAllProducts();
//YS: Missing try/catch
function addProducts(req, res) {
    var id = uuidv4(); //YS: You can add this into your product class instead of here: this.id = uuidv4()
