...
function loginUser(req, res) {
    try {
        ...
        var isUserPassOK = allUsers.some(function (elem) { return elem.email === email_1 && elem.password === password_1; }); //YS: It doesnt let me log in since the password is encrypted so the passwords will never be equal
        if (isUserPassOK) {
