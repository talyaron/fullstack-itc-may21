...
function addBooks(ev) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, title, author, newBook, book, link, e_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    _a = ev.target.elements, title = _a.title, author = _a.author;
                    title = title.value;
                    author = author.value;
                    newBook = {
                        title: title,
                    ...
                    return [4 /*yield*/, addBooksAxios(newBook)];
                case 2:
                    book = _b.sent();
