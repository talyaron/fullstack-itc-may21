...
exports.validateSearch = exports.validateBook = void 0;
var Ajv = require("ajv");
...
//this is in some way irrelevant because is always a type of an input is a string
function validateSearch(schema) {
    return function (req, res, next) {
        var valid = ajv.validate(schema, req.body);
        if (!valid) {
            var propError = ajv.errors[0].instancePath.replace('/', '');
