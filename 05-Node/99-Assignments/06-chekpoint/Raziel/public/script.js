        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    ev.preventDefault();
                    _a = ev.target.elements, bookName = _a.bookName, bookAuth = _a.bookAuth;
                    bookName = bookName.value;
                    bookAuth = bookAuth.value;
                    if (!bookName || !bookAuth)
                        throw new Error("Please fill the missing fields");
                    ev.target.reset();
                    newBook = { bookName: bookName, bookAuth: bookAuth };
                    return [4 /*yield*/, axios.post("/books/newBook/", newBook)];
                case 1:
                    bookInfo = _b.sent();
                    return [3 /*break*/, 3];
                case 2:
