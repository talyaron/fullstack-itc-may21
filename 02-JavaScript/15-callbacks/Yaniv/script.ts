...
let arrayToSearchIn: Array<Student> = [{name:'Raziel'},{name:'Tal'},{name:'Yarden'},{name:'Yehuda'},{name:'Avromi'},{name:'Efrayim'},{name:'Refael'},{name:'Jonathan'},{name:'Tomas'},{name:'Eric'},{name:'Tomas'},{name:'Golan'},{name:'Julie'},{name:'Emmanuel'},{name:'Leo'}];
