...
function () {
  ...
  BookingList.prototype.renderBooking = function (customer, Hotels) {
    try {
      ...
      var result = Hotels_1.filter(function (element) {
