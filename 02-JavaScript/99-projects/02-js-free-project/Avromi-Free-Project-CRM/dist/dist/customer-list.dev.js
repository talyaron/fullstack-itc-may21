...
function removeCustomer(customerId) {
  this.customers = this.customers.filter(function (cus) {
...
function handleClick(id) {// const customerId = id
...
function myFilter() {
  ...
  document.querySelector("#myFilter").addEventListener("keyup", function (event) {
    ...
    var result = _this.customers.filter(function (customer) {
      return customer.name.includes(searchInput);
    });
