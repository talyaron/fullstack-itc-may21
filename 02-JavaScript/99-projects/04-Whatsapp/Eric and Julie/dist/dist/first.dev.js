...
var render = document.querySelector(".wrapper__container--chats"); //popup to add a new contact
...
function handleDelete(contactId) {
  var reducedContacts = contacts.contacts.filter(function (contact) {
...
faPlus.addEventListener('click', function (e) {
  return openModal(e);
}); //open modal window
