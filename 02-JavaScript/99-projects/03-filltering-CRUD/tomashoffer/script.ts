...
const nuevoProducto = new ProductList()
...
const handleSubmit = (e: any): void =>{
    e.preentDefault();
    const product:string = e.target.elements.product.value;
    ...
    const newProduct = new Product(product, brand, price, stock, description);
