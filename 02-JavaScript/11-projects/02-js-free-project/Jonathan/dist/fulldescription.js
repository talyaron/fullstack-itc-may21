var getHotel = JSON.parse(localStorage.getItem('checkedHotel')); //check the hotel
...
function renderDescription() {
    var html = " ";
    getHotel.forEach(function (element) {
        var encontrarIndex = Hotels.findIndex(function (algo) { return algo.name === element.name; });
