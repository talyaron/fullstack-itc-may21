...
function pikachuMove() {
  try {
    ...
    var positionX = parseInt(pikachu.style.left); //YS: Good 
    ...
    document.addEventListener('keydown', function (ev) {
      ...
      if (ev.key == "ArrowDown") {
        ...
        positionY = parseInt(pikachu.style.top); //pikachu.style.transform = "rotate(90deg)"     //YS: Please don't leave commented code in your work (you can leave comments but not commented code).
