...
var move = 10;
var Top = 0; //YS: Dont capitalize variable names. We use camelCase. 

var Left = 0;

document.onkeydown = function (event) {
  //YS: Better practice to write: document.body.addEventListener('keydown', function(event) {...})
  try {
    if (img2 === null) {
      //YS: You can also write < if(!img2) >   and you are missing another error:  < if(!tennis) throw new Error()   >
    ...
    switch (event.keyCode) {
      ...
      /*YS: Nice work! Very clear and organized code. Good use of switch statements, const/let
